...
help:
	...
	@echo "               Example: make run input=testcases/good/define_eval"
	@echo "  runall     - Run the compiled program with all testcases (good and bad)"
	@echo "               Usage: make runall"
	@echo "               Output: results/all.out"
	@echo "  runallgood - Run the compiled program with all good testcases"
	@echo "               Usage: make runallgood"
	@echo "               Output: results/good.out"
	@echo "  runallbad  - Run the compiled program with all bad testcases"
	@echo "               Usage: make runallbad"
	@echo "               Output: results/bad.out"
